...
export const config = {
  ...
  ragEnabled: boolean(process.env.MAIA_RAG_ENABLED),
  ragUrl: (process.env.MAIA_RAG_URL || 'http://127.0.0.1:4310').replace(/\/$/, ''),
  ragCollectionId: process.env.MAIA_RAG_COLLECTION_ID || '',
  ragTimeoutMs: Number(process.env.MAIA_RAG_TIMEOUT_MS || 30000),
  ragTopK: Number(process.env.MAIA_RAG_TOP_K || 4),
  ragMaxContextChars: Number(process.env.MAIA_RAG_MAX_CONTEXT_CHARS || 8000),
